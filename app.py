...
async def hf_catalog(body:dict):
 ...
 try:
  ...
  return {'ok':True,'free_now':free,'free_credit_starters':starters,'all':allm,'free_now_count':len(free),'monthly_free_credit_note':'HF free-tier availability can change; SS does not label a model FREE unless the provider reports zero price/free status.'}
