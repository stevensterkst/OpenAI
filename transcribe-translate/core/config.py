...
def load_config(path: Path | None = None) -> AppConfig:
    ...
    return AppConfig(
        ...
        ollama_model=text.get("ollama_model", "phi4-mini:3.8b"), ollama_num_predict=max(1024, int(text.get("ollama_num_predict", 1024))), analysis_language=str(text.get("analysis_language", "source")),
